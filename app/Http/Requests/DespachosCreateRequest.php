...
class DespachosCreateRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'codigoDespacho'    => 'required|string|max:20|unique:despachos,codigoDespacho',
            'nombreDespacho'    => 'required|string|max:95|unique:despachos,nombreDespacho',
            ...
            'creador'           => 'nullable|string|max:50',
        ];
    }
}
