...
class BiometriaParqueaderoController extends Controller
{
    ...
    {
         //dd($request);
        return view('monitoreo.Biometria.Index');
    }
         ...
         DB::beginTransaction();
            try{ 
             ...
             if(empty($verificacion))                 {
                    ...
                    return view('monitoreo.Biometria.CargarFoto',compact('verificacion'));
                     ...
                     return view('monitoreo.Biometria.MostrarFoto',compact('verificacion'));
    ...
    public function store(Request $request)
    {
       ...
       $identificacion= (int) $request->identificacion;
        ...
        $verificacion =BiometriaIngreso::where('identificacion',$identificacion)->first();
        //dd($identificacion,$verificacion);
        ...
        if(empty($verificacion) || empty($verificacion->foto))
            ...
            try{ 
             ...
             return redirect()->route('biometria.Parqueadero.inicio');
    ...
    public function registrarSalida(Request $request){
        return view('monitoreo.Biometria.Salida');
    }
       ...
       // dd($verificacion->count());
        ...
        if(!empty($verificacion)){
          ...
          $mensaje = ['mensaje' => 'Registro de salida exitoso... <br> Feliz día!!','codigo'=>'1'];
            ...
            //dd($UsuarioHora);
            $mensaje = ['mensaje' => 'Error al Registra la salida, cedula ' . $id .' no esta registrada <br>Feliz día!','codigo'=>'0'];
