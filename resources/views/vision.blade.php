...
@if($institucional != null)
   ...
   @if($institucional[0]->iTipo == "Vision")

    @foreach($institucional as $itcl)

        @if ($itcl->iTipo == 'Vision')
        ...
        <div class="col-md-7 col-md-push-5">
            ...
            <p class="lead" style="word-wrap: break-word;height: auto;width: 100%; text-align: justify;">
