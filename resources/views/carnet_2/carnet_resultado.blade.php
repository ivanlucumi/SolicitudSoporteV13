...
<head>
    ...
    <meta name="theme-color" content="#005a4e">
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .hero {
            background: linear-gradient(135deg, #005a4e 0%, #004182 55%, #00a38f 100%);
        ...
        .footer-carnet {
            background: linear-gradient(135deg, #005a4e 0%, #00a38f 100%);
            color: #fff;
            padding: 10px;
            font-weight: 700;
            border-radius: 12px;
        ...
        .btn-pwa { background: #005a4e; color: white; width: 100%; justify-content: center; font-size: 1rem; padding: 14px;}
...
<body oncontextmenu="return false;">
    ...
    <main class="main-content">
        ...
        <div class="acciones">
            <button class="btn btn-pwa" id="btnSaveToPhone" onclick="saveToPhone()">
                <i class="fa-solid fa-mobile-screen-button"></i> Generar PWA / Guardar en Móvil
            </button>
    ...
    <div id="validationModal" class="modal">
        <div class="modal-content" id="modalContent">
            <div class="loading-state" id="loadingState">
                ...
                <div id="modalSpinInitials" class="fa-spin" style="width: 90px; height: 90px; border-radius: 50%; background: #005a4e; color: white; display: none; align-items: center; justify-content: center; font-size: 36px; font-weight: bold; border: 4px solid #059669; margin: 0 auto; box-shadow: 0 4px 10px rgba(0,0,0,0.1);"></div>
    ...
    <div id="installGuideModal" class="modal">
        <div class="modal-content" style="text-align:center;">
            ...
            <p style="font-size:0.95rem; color:#475569; margin-bottom:20px; text-align:left;">
                ...
                <br><br>
                <strong>📱 En iPhone (Safari):</strong> Toca el ícono de "Compartir" en la barra inferior y luego selecciona <strong>"Agregar a Inicio"</strong>.
                <br><br>
            ...
            <button class="btn btn-pwa" onclick="window.location.href='/mi-carnet" style="width:100%; justify-content:center;">
    ...
    <script>
        ...
        function saveToPhone() {
            ...
            // Disparar Prompt de Instalación PWA si está disponible
            if (deferredPrompt) {
                ...
                deferredPrompt.userChoice.then((choiceResult) => {
                    ...
                    deferredPrompt = null;
                    window.location.href = "{{ route('carnet.pwa') }}";
                });
            } else {
        ...
        function validateIdentity() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.activo) {
                        iconDiv.innerHTML = '<i class="fa-solid fa-circle-check status-ok"></i>';
