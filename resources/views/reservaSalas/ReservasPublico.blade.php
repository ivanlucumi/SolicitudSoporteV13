...
?>
  ...
  <h1>PROGRAMACI&Oacute;N DE AUDIENCIAS PALACIO DE JUSTICIA CALI -- <strong> {{ \Carbon\Carbon::parse(\Carbon\Carbon::Now())->translatedFormat('d-M-Y') }}</strong></h1>
