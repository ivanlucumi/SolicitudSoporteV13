...
?>
  ...
  <h1>PROGRAMACI&Oacute;N DE AUDIENCIAS PALMIRA -- <strong> {{ \Carbon\Carbon::parse(\Carbon\Carbon::Now())->translatedFormat('d-M-Y') }}</strong></h1>
...
<script>
  ...
  function cargarDatos() {
    ...
    $.ajax({
      url: '/reservas/salas/ajax/palmira',
      type: 'GET',
      dataType: 'json',
