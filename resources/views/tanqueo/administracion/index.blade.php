 ...
 window.onload = function() {
    ...
    // campoArchivo.value = '';
        ...
        if (esDispositivoMovil) {
            ...
            document.getElementById('opcionesCamara').style.display = 'block';
    ...
    <div class="container-fluid">
        <div class="row ">
            <div class="col-xs-12 col-sm-3">
                <div class="container">	
            	 <a href="{!! route('regsitro.vehiculo.export')!!}" class="btn btn-warning">Descargar Registros </a>          
            	</div>
            	</div>
...
@enderror
    ...
    @csrf
            <div class="col-xs-12 col-sm-4 form-group ">
                <label for="conductor">PLACA:</label>
                <input id="id_vehiculo" class="form-control  @error('id_vehiculo') is-invalid @enderror" autocomplete="off" placeholder="Ingrese Placa Vehiculo" type="text" name="id_vehiculo" value="{{ old('id_vehiculo') }}">
@error('id_vehiculo')
    <div class="invalid-feedback">{{ $message }}</div>
@enderror
...
@enderror
            ...
            <div class="col-xs-12 col-sm-12" id="opcionesCamara" style="display:none;">
...
(function() {
  ...
  <script>
       //EMPLEADO
     var resultadoDiv = document.getElementById("info-vehiculo");
    var verifPlaca= document.getElementById('id_vehiculo');
    verifPlaca.addEventListener('input', function() 
    {
         ...
         var form = $('#form-registro-vehiculo');
          ...
          var url = form.attr('action').replace(':VEHICULO_ID', verifPlaca.value);
          var data = form.serialize();
          //alert(url)
          $.get(url, data, function(result) {
              if (Object.keys(result).length > 0) {
                ...
                //console.log(soat)
                //console.log(tecno)
                document.getElementById("TECNO").style.backgroundColor = "";
                document.getElementById("SOAT").style.backgroundColor = "";
...
<script>
    ...
    verifCedula.addEventListener('input', function() 
    {
        ...
        $.get("consulta/conductor/" + this.value + "", function(response, juzgado) {

            console.log(response.nameE)
            if (Object.keys(response).length > 0) {
                document.getElementById('nombre_conductor').value = response.nameE + response.lastnameE;
