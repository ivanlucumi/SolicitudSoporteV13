...
<P><strong><h2><center>PROCESOS CORREGIDOS SERVISOFT PROTOCOLO 2.</center></h2></strong> </P><hr>
<div class="container">
    <div class="row">
        <div class="col-xs-12 col-sm-3">
            CORREGIDOS:<h1 style="color:red"> {{$CorregidoUser}}</h1>
        </div>
...
$("table").tableExport({
	...
	fileName: "Reporte Corregido Protocolo 2",    //Nombre del archivo 
});
