...
<div class="container-fluid">
    ...
    @csrf 
            <div class="col-xs-12 col-sm-4">
            	        	<input class="form-control " placeholder="Seleccione Despacho para Reparto" autocomplete="off" type="hidden" name="despacho_id" id="despacho_id" value="{{  auth()->user()->cedula }}"> 
            </div>
            <div class="col-xs-12 col-sm-4">
                <br>
                <button class="btn btn-success btn-block" type="submit">CREAR SOLICITUD DE DESPACHO</button>
