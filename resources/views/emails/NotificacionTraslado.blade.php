...
@section('content')
@section('cabecera', 'Notificacion de Traslado de Demanda!')
  <!-- Main content -->
  <p><span class="derecha">Fecha: <?php $time = time(); echo date("d-m-Y", $time);?></span></p>
  
  <p>
      
      <h2>Confirmaci&oacute;n  Traslado Demanda</h2> <br>
  </p>
...
<hr>
  ...
  <hr>
  <div style="color: black; font-size: 18px; text-transform: uppercase;"><b>Motivo Traslado a Reparto</b></div><br>
  
  <p style="color: black; font-size: 12px;">{{$traslado}}</p>
