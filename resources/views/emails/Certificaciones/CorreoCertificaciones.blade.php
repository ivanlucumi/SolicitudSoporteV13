  ...
  <div style="max-width:600px; margin:0 auto; background:#ffffff; border-radius:16px; box-shadow:0 8px 30px rgba(15,23,42,0.12); overflow:hidden;">
    ...
    <div style="padding:30px 28px;">
      ...
      <p style="font-size:15px; margin:0 0 18px; color:#334155;">
        Se ha realizado el envío de su consulta de certificación laboral y, conforme a su solicitud, se remite el enlace correspondiente para su descarga:
      </p>
      ...
      <p style="font-size:15px; margin:0 0 18px; color:#334155;">
        Puede visualizar la información completa en el siguiente enlace el cual tiene una vigencia de 24 horas:
      </p>
      ...
      <p style="margin-top:26px; font-size:13px; color:#64748b;">
        Si llega a presentarse alguna novedad o inconsistencia en la certificación laboral, le solicitamos remitir la información al correo: cldisajcali@cendoj.ramajudicial.gov.co, donde será atendida por el equipo responsable.
      </p>
