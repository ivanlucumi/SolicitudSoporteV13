...
@section('content')
@section('cabecera', 'Solicitud Sala Audiencia')
  <!-- Main content -->
  <p><span class="derecha">Fecha: <?php $time = time(); echo date("d-m-Y", $time);?></span></p>
  <p ><span class="izquierda"><h2>Se&ntilde;ores</h2></span></p>
  <p class="izquierda"><strong > <h3>DESPACHO </h3></strong></p>
  <p class="izquierda"><strong ><h4>{{$despacho}} </h4></strong></p><br>
  
  
  
  <p>
      <h3>Reporte de Eliminacion Reserva Sala.</h3>
  </p>
    
<hr>
  <div style="color: black; font-size: 18px; text-transform: uppercase;"><b>Detalles Eliminaci&oacute;n de la Reserva</b></div><br>
  ...
  <table>
    ...
    <tr>
      <td><b>Demandante o Fiscalia:</b></td>
      <td> {{$nombre_fiscal}} </td>
    </tr>
    <tr>
      <td><b>Demandado o Indiciado:</b></td>
      <td>{{$nombre_fiscal}} </td>
    </tr>
    <tr>
      <td><b>Sala:</b></td>
