...
@section('content')
@section('cabecera', 'Notificacion Rechazo de Demanda!')
  <!-- Main content -->
  <p><span class="derecha">Fecha: <?php $time = time(); echo date("d-m-Y", $time);?></span></p>
  
  <p>
      
      <h2>Confirmaci&oacute;n  Rechazo Demanda</h2> <br>
  </p>
...
<hr>
  ...
  <hr>
  <div style="color: black; font-size: 18px; text-transform: uppercase;"><b>Motivos Por el Cual se Rechaza Demanda</b></div><br>
  
  <p style="color: black; font-size: 12px;">{{$rechazo}}</p>
