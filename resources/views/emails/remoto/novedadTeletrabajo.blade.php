...
@section('content')
@section('cabecera', 'Novedad en Registro Teletrabajo')
  <!-- Main content -->
  ...
  <p>
      <h2>Novedad Registrada Documentos Teletrabajo</h2> <br>
  </p>
...
<hr>
  ...
  <p>
      Se ha registrado una novedad en la solicitud de Teletrabajo.
      Debe Verificar Directamente en SIRIS 
