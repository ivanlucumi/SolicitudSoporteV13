...
@section('title', 'Proceso Para Reparto')

@section('content')
@section('cabecera', 'Documentos cargados con Exito!')
  <!-- Main content -->
  <p><span class="derecha">Fecha: <?php $time = time(); echo date("d-m-Y", $time);?></span></p>
  
  <p>
      <h3>Proceso Para Reparto.</h3><br>
      <h2>Confirmaci&oacute;n De Envio de Proceso para Reparto</h2> <br>
  </p>
