...
@section('content')
@section('cabecera', 'Ficha de Preliminar ')
    ...
    <div style="background:linear-gradient(135deg, #0ea5e9, #2563eb); padding:20px 24px; color:#ffffff;">
      <div style="display:flex; align-items:center; justify-content:space-between; gap:12px;">
        <div>
          ...
          <h1 style="margin:4px 0 0; font-size:20px; font-weight:700;">Ficha de Preliminar</h1>
        </div>
    ...
    <div style="padding:16px 24px; background:#ecfeff; border-bottom:1px solid #e2e8f0;">
      <div style="display:flex; align-items:flex-start; gap:10px;">
        ...
        <p style="margin:0; font-size:14px; color:#0f172a;">
          Notificaci&oacute;n de Cambio de Tipo Solicitud - Sistema Penal Acusatorio
        </p>
      </div>
    </div>
...
<!-- Contenido principal -->
    <div style="padding:24px;">
      ...
      <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:separate; border-spacing:0 10px;">
        ...
        <tr>
        <td style="width:35%; font-size:13px; color:#64748b;"><b>Quien Solicita:</b></td>
          <td style="font-size:14px; color:#0f172a;">{{$quien_solicita}} CC: {{$cedula_quien_solicita}} </td>
        </tr>
        <tr>
          <td style="width:35%; font-size:13px; color:#64748b;">Funcionario que Cambia Tipo Solicitud</td>
          <td style="font-size:14px; color:#0f172a;">{{ $id_usuario_cambia }}</td>
        <tr>          
        <tr>
        ...
        <tr>
          <td style="width:35%; font-size:13px; color:#64748b;"><b>Funcionario Quien Cambia Tipo Solicitud:</b></td>
          <td>{{$id_usuario_cambia}} </td>
        </tr>        
        <tr>
