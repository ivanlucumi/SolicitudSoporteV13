...
@section('title', 'Solicitud a Almacen')
@section('content')
<style>
    .custom-table {
        width: 100%;
...
<hr>
  <div style="color: black; font-size: 18px; text-transform: uppercase;"><b>Se realiz&oacute; la Solicitud de los siguinetes Elementos a Almac&eacute;n</b></div><br>
                   
  <hr>
  <div style="color: black; font-size: 18px; text-transform: uppercase;"><b>Detalles de la Solicitud de Elementos</b></div><br>
  ...
  <p>
      Es importante tener en cuenta que, a pesar de haber recibido su solicitud de elementos a almacén, la entrega de estos está sujeta a la disponibilidad actual en el inventario.
  </p>
