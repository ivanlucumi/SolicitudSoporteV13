...
@section('title', 'Codigo Verificacion')

@section('content')
@section('cabecera', 'Notificaci&oacute;n C&oacute;digo Ingreso!')
  <!-- Main content -->
  <p><span class="derecha">Fecha: <?php $time = time(); echo date("d-m-Y", $time);?></span></p>
  
  <p>
      
      <h2>Confirmaci&oacute;n  C&oacute;digo</h2> <br>
  </p>
    
<hr>
  <div style="color: black; font-size: 18px; text-transform: uppercase;"><b>Datos Para Ingreso</b></div><br>
  ...
  <table>
    ...
    <tr>
      <th style="width: 35%;">URL Temporal</th>
      <th>
           <center>
               <a href="{{ $urlTemp }}" target="_blank" style="display: block;
                width: 115px;height: 30px;background: rgb(0, 125, 110);padding: 5px;text-align: center;border-radius: 3px;
                color: white; font-weight: bold;">Ingresar</a>
