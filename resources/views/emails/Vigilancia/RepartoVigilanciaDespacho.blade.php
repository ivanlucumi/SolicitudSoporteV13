  ...
  <div style="max-width:680px; margin:0 auto; background:#ffffff; border-radius:12px; overflow:hidden; box-shadow:0 6px 24px rgba(2,6,23,0.08);">
      ...
      <div style="display:flex; justify-content:space-between; align-items:center;">
        <div>
          ...
          <h1 style="margin:6px 0 0; font-size:20px; font-weight:700;">
            Remisión de Reparto – Vigilancia Judicial
          </h1>
        </div>
    ...
    <div style="padding:24px;">
      ...
      <p style="font-size:14px; color:#334155; text-align:justify;">
        Cordial saludo,
        <br><br>
        Nos permitimos informarle que la <strong>solicitud de vigilancia judicial</strong> ha sido
        <strong>debidamente repartida</strong>. Se adjunta el <strong>acta de reparto</strong> como constancia del trámite realizado.
        <br><br>
        Así mismo, se ha enviado copia del acta de reparto al solicitante para su conocimiento y referencia.
      </p>
      ...
      <div style="font-size:14px; font-weight:700; text-transform:uppercase; color:#111827; margin-bottom:12px;">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse:separate; border-spacing:0 10px;">
        ...
        <tr>
          <td style="font-size:13px; color:#64748b;">Observaciones</td>
          <td style="font-size:14px;">{{ $observaciones }}</td>
        </tr>
        @endif
    ...
    <div style="padding:18px 24px; background:#0b1220; color:#e2e8f0;">
      ...
      <p style="margin:0; font-size:11px; color:#cbd5e1;">
        <strong>Aviso de confidencialidad:</strong> Este correo contiene información de la Rama Judicial de Colombia.
        Si no es el destinatario, notifíquelo y elimine este mensaje. El uso no autorizado puede generar
        responsabilidades legales conforme a la Ley 1273 de 2009 y demás normas aplicables.
      </p>
    </div>
