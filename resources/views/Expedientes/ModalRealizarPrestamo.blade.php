    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel"><strong> SOLICITAR PRESTAMO DE EXPEDIENTE</strong> </h5>
    ...
    @csrf
          <div class="container-fluid">
            <div class="col-xs-12 col-xs-12">
                    ...
                    <input class="form-control form-group mr-sm-2 shadow @error('radicado') is-invalid @enderror" placeholder="Registrar Radicacion" autocomplete="off" type="number" name="radicado" id="radicado" value="{{ old('radicado') }}">
@error('radicado')
