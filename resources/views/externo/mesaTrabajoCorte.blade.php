  ...
  <main role="main" class="container">
    <div class="row">
      ...
      <div class="col-xs-12  col-md-6">
        <img src="/img/sala_casacion.jpeg" class="img-responsive" width="380" height="220">
      </div>
...
<div class="container-fluid">
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="col-md-9">
                <div class="card-header justify-content-center" align="center" style="background-color: #004182;color:white"><h3>Registro Asistencia Conversatorio Especialidad Laboral de la Corte Suprema de Justicia<br>Cali, 12 al 14 de Octubre 2022</h3></div>
                <div>
                    ...
                    <div class="form-group row">
                         ...
                         <div class=" col-xs-12 col-md-6">
                                  ...
                                  <input class="form-control @error('identificacion') is-invalid @enderror" placeholder="No. de identificaci&oacute;n" min="1" autocomplete="off" id="nid" type="number" name="identificacion" value="{{ old('identificacion') }}">
...
@enderror
                    ...
                    <hr>
                      <form action="{{ route('corte.evento.store') }}" method="POST">
    @csrf
                    <div class="form-group row">
...
@enderror
                        ...
                        <div class=" col-xs-12 col-md-5">
                                  ...
                                  <input class="form-control @error('correo') is-invalid @enderror" placeholder="Email" min="1" autocomplete="off" id="correo" type="text" name="correo" value="{{ old('correo') }}">
@error('correo')
    <div class="invalid-feedback">{{ $message }}</div>
@enderror
                        </div>
                        <div class=" col-xs-12 col-md-4">
                                  <label for="oficinaReparto">CARGO</label>
                                  <input class="form-control @error('cargo') is-invalid @enderror" placeholder="Cargo" min="1" autocomplete="off" id="cargo" type="text" name="cargo" value="{{ old('cargo') }}">
@error('cargo')
    <div class="invalid-feedback">{{ $message }}</div>
@enderror
                        </div>
                        <div class=" col-xs-12 col-md-3">
                                  <label for="oficinaReparto">CIUDAD</label>
                                  <input class="form-control @error('ciudad') is-invalid @enderror" placeholder="Ciudad" min="1" autocomplete="off" id="ciudad" type="text" name="ciudad" value="{{ old('ciudad') }}">
@error('ciudad')
    <div class="invalid-feedback">{{ $message }}</div>
@enderror
                        </div>
                         <div class=" col-xs-12 col-md-8">
                                  <label for="oficinaReparto">ENTIDAD A LA QUE PERTENECE</label>
                                  <input class="form-control @error('entidad') is-invalid @enderror" placeholder="Entidad" autocomplete="off" id="entidad" type="text" name="entidad" value="{{ old('entidad') }}">
@error('entidad')
    <div class="invalid-feedback">{{ $message }}</div>
@enderror
                        </div>
                        <div class=" col-xs-12 col-md-4">
                                  <label for="oficinaReparto">TEL&Eacute;FONO DE CONTACTO</label>
                                  <input class="form-control @error('numero_contacto') is-invalid @enderror" placeholder="Tel&eacute;fono Contacto" autocomplete="off" id="telefono_contacto" type="text" name="numero_contacto" value="{{ old('numero_contacto') }}">
@error('numero_contacto')
    <div class="invalid-feedback">{{ $message }}</div>
@enderror
                        </div>
                        <div class=" col-xs-12 col-md-6">
                                  <label for="oficinaReparto">SELECCIONE MESA DE TRABAJO:</label>
                                  <select class="form-control @error('mesa') is-invalid @enderror" autocomplete="off" name="mesa" id="mesa">
    <option value="">Seleccion Mesa Trabajo</option>
    @foreach($mesa as $key => $value)
        <option value="{{ $key }}" @selected(old('mesa') == $key)>{{ $value }}</option>
    @endforeach
</select>
@error('mesa')
    <div class="invalid-feedback">{{ $message }}</div>
@enderror
        ...
        <div class="col-md-3">
            <div class="card-body">
                 <div class="card-header justify-content-center" align="center" style="background-color: #004182;color:white"><h4>Máximo 40 Participantes por Mesa</h4></div>
                        <div class="table-responsive">
                              ...
                              <table  class=" table-hover table-condensed table-bordered ">
                                  <thead style="background-color: #AFAFAF; color: #fff;">
                                      ...
                                      <tbody class="buscar">
                                          @foreach($registros as $key => $Regsitro)
                                          
                                          <tr class="table-light">   
                                              <th scope="row">{{ $Regsitro->mesa_trabajo }}</th>
                                              <th scope="row">{{ $Regsitro->participantes }}</th>
                                          </tr>
                                          @endforeach	 
    ...
    <div class="row justify-content-left">
        <div class="col-md-12">
            <div class="card-body">
                 <div class="card-header justify-content-center" align="center" style="background-color: #004182;color:white"><h4>LISTA DE PARTICIPANTES INSCRITOS</h4></div>
                        <div class="table-responsive">
                              <table id="table9"  class="table table-hover table-condensed table-bordered ">
                                  <thead style="background-color: #AFAFAF; color: #fff;">
                                      ...
                                      <tbody class="buscar">
                                          ...
                                          <tr class="table-light">   
                                              <th scope="row">{{ $participante->cedula }}</th>
                                              <th scope="row">{{ $participante->nombre }}</th>
                                              <th scope="row">{{ $participante->cargo }}</th>
                                              <th scope="row">{{ $participante->entidad }}</th>
                                              <th scope="row">{{ $participante->mesa_trabajo }}</th>
                                              <th scope="row">{{ $participante->numero_contacto }}</th>
                                          </tr>
                                          @endforeach	 
...
<script language="JavaScript">
  //VISITANTE
    ...
    verifCedula.addEventListener('input', function() {
        ...
        $.get("/consulta/cedula/corte/" + this.value + "", function(response, juzgado) {
            ...
            if (Object.keys(response).length > 0) {
                ...
                document.getElementById('entidad').value = response.entidad;
                document.getElementById('telefono_contacto').value = response.numero_contacto;
            } else {
