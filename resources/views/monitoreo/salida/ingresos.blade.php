...
<div class="row">
    <div class="col-xs-12 col-sm-3">
        ...
        <div class="" style="text-align: left">
            ...
            <input class="form-group mr-sm-2 shadow" name="cedula" type="number"  placeholder="Buscar por Cedula" aria-label="Search" id="cedulaIngreso" required autofocus>
               <input class="form-group mr-sm-2 shadow" name="primer_ap" type="text" style="width : 80px; heigth : 10px"  aria-label="Search" id="primer_ap" >
               <input class="form-group mr-sm-2 shadow" name="segundo_ap" type="text" style="width : 80px; heigth : 10px"  aria-label="Search" id="segundo_ap" >
               <input class="form-group mr-sm-2 shadow" name="primer_nomb" type="text"  style="width : 80px; heigth : 10px" aria-label="Search" id="primer_nomb" >
               <input class="form-group mr-sm-2 shadow" name="segundo_nomb" type="text" style="width : 80px; heigth : 10px"  aria-label="Search" id="segundo_nomb" >
               <input class="form-group mr-sm-2 shadow" name="sexo" type="text" style="width : 80px; heigth : 10px"  aria-label="Search" id="sexo" >
               <input class="form-group mr-sm-2 shadow" name="fecha_nacimiento" style="width : 80px; heigth : 10px" type="text"   aria-label="Search" id="fecha_nacimiento" >               
               <input class="form-group mr-sm-2 shadow" name="tipo_sangre" type="text" style="width : 80px; heigth : 10px"  aria-label="Search" id="tipo_sangre" >
                
                <a href="#" class="btn btn-success btn-sm 
                                    fa fa-plus-square" id="BVcedulaIngreso" title="Buscar por c&eacute;dula"> Buscar</a>
...
@if($ingresos != null)
        ...
        <tbody class="buscar" data-id="{!!$ingreso->id!!}" >
            ...
            background-color:#BFFCC0 ;@endif">
                ...
                <th scope="row">{{strtoupper($ingreso->persona->nombre)}}</th>									
                <th scope="row">{{strtoupper($ingreso->persona->apellidos)}}</th>									
...
<script>
    ...
    setInterval(FocusAutomatico, 10000); 
</script>
