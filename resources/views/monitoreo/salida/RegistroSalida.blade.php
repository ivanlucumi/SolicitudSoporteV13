...
@section('content') 
    ...
    <div class="col-xs-12">
        ...
        <div class="" style="text-align: right">
            <label ><h3><strong>INGRESOS:</strong> </h3></label> <span style="color:#c0392b;font-size: 30px"; id="ingresos">{{$ingresos}}</span><br>
            <label><h3><strong>SALIDAS: </strong></h3></label> <span style="color:#c0392b;font-size: 30px"; id="salidas">{{$salidas}}</span>
          </div>
...
$('#BcedulaSalida').click(function(e) {
                    ...
                    $.get(url, data, function(result) {
                        ...
                        console.log(result.SALIDAS);
                        
                        $('#ingresos').text(result.INGRESOS);
                        $('#salidas').text(result.SALIDAS);
                        
                       if(result.codigo === 1){
                           toastr.success('<br /> <strong> <h1>'+result.mensaje+'</h1>',"SALIDA REGISTRADA");  
                       }else{
                           toastr.error('<br /> <strong> <h1>'+result.mensaje+'</h1>',"ERROR AL REGISTRAR"); 
                       }
