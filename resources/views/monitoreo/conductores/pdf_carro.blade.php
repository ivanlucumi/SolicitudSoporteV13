...
<head>
    <meta charset="utf-8">
    <title>Inspección Automotor</title>
    <style>
        ...
        th, td { border: 1px solid #000; padding: 4px; text-align: left; vertical-align: middle; word-wrap: break-word; overflow-wrap: break-word; }
        .header-bg { background-color: #2e7d32; color: #fff; font-weight: bold; text-align: center; }
        .subheader-bg { background-color: #e0e0e0; color: #000; font-weight: bold; text-align: left; }
...
<body>
    <div class="logos-container">
        <table style="border:none; margin-bottom: 5px;">
            <tr>
                ...
                <td style="border:none; text-align:center; width:33%; font-weight:bold; font-size:13px; color: #2e7d32;">
                    INSPECCIÓN PREOPERATIVA DE AUTOMOTORES
                </td>
    ...
    <table>
        ...
        <tr>
            <td colspan="2" width="50%" class="header-bg">Información del Automotor</td>
        ...
        <tr>
            ...
            <td class="text-bold">Dependencia / Sede:</td>
            <td>{{ $vehiculo ? ($vehiculo->edificio . ' · ' . $vehiculo->despacho) : 'N/A' }}</td>
        </tr>
    </table>
    ...
    <table>
        <tr>
            ...
            <th class="header-bg" width="45%">Lista de Chequeo / Verificación</th>
            <th class="header-bg text-center" width="8%">Bueno SI</th>
            <th class="header-bg text-center" width="8%">Malo NO</th>
        ...
        @foreach($detallesAgrupados as $grupo => $detalles)
            @if($grupo !== 'REPORTE DE LAS CONDICIONES DE SALUD DEL CONDUCTOR*')
                <tr>
                    <td colspan="5" class="subheader-bg">{{ $grupo }}</td>
                </tr>
    ...
    <table style="border:none; margin-top: 15px;">
        <tr>
            ...
            <td style="border:none; width:40%; vertical-align: bottom; text-align: right; font-size: 10px;">
                <strong>Código:</strong> F-SGSST-105<br>
