...
<form action="{{ route('empleados.store') }}" method="POST" id="formEmpleado" novalidate>
  @csrf
    ...
    <div class="row">
      <div class="col-md-8">
        ...
        <div class="form-group-min">
          <label for="cedula">Cédula Empleado <span class="req">*</span></label>
          <input type="text" name="cedula" class="form-control" id="cedula" placeholder="Ingresa número de documento" required>
        </div>

        <div class="form-group-min">
          <label for="nombre">Nombre(s) <span class="req">*</span></label>
          <input type="text" name="nombre" class="form-control" id="nombre" placeholder="Nombres completos" required>
        </div>

        <div class="form-group-min">
          <label for="apellido">Apellido(s) <span class="req">*</span></label>
          <input type="text" name="apellido" class="form-control" id="apellido" placeholder="Apellidos completos" required>
        </div>

        <div class="form-group-min">
          <label for="cargo_titular">Cargo / Rol</label>
          <input type="text" name="cargo_titular" class="form-control" id="cargo_titular" list="cargos-list" placeholder="Escribe o selecciona... (ej. JUEZ)">
        ...
        <div class="form-group-min">
          <label for="cod_despacho">Despacho Autorizado</label>
          ...
          <small class="text-muted" style="font-size: 0.75rem;">Aviso: Al elegir se vinculará automáticamente la dependencia.</small>
        </div>

        <div class="form-group-min">
          <label for="ciudad_ubicacion_laboral">Sede / Ubicación Laboral</label>
          <input type="text" name="ciudad_ubicacion_laboral" class="form-control" id="ciudad_ubicacion_laboral" placeholder="Ej: Nueva York, Piso 4">
        </div>

        <div class="row">
          <div class="col-md-6 form-group-min">
            <label for="fecha_expedicion">Fecha de Expedición Carnet</label>
            <input type="date" name="fecha_expedicion" class="form-control" id="fecha_expedicion">
          </div>
          <div class="col-md-6 form-group-min">
            <label for="fecha_retiro">Fecha de Vigencia</label>
            <input type="date" name="fecha_retiro" class="form-control" id="fecha_retiro">
          </div>
        </div>
      ...
      <div class="col-md-4 text-center">
        ...
        <div class="photo-card">
          <img id="fotoPreview" src="{{ asset('img/carnet/default.png') }}" alt="Foto">
          <div class="form-group-min" style="margin-top: 1rem; margin-bottom: 0;">
            ...
            <small class="text-muted" style="font-size: 0.75rem;">Procesamiento nativo (300x400 JPG)</small>
          </div>
