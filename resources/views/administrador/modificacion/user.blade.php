...
@section('title', 'actualizar Empleados por Excel ')
@section('cabecera', 'actualizar a travez Carga de Excel Empleados')
...
<div class="row">
  ...
  <div class="col-xs-12 col-md-8">
    <form method="POST" action="/administrador/update/update/user" accept-charset="UTF-8" enctype="multipart/form-data">  
