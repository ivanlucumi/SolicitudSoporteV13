...
@section('title', 'Modificar correo de Despachos ')
@section('cabecera', 'Carga de Excel Despachos')
...
<div class="row">
  ...
  <div class="col-xs-12 col-md-8">
    <form method="POST" action="/administrador/update/update/despachos" accept-charset="UTF-8" enctype="multipart/form-data">  
