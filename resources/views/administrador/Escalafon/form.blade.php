...
<div class="card card-consulta shadow-lg border-0 rounded-4 animate__animated animate__fadeInDown">
    ...
    <!-- BODY -->
        <div class="container-fluid">
            <form method="GET" action="{{ route('admin.consulta.escalafon.form') }}">
                @csrf
    ...
    <hr>
                ...
                <div class="d-flex justify-content-center gap-3 mt-5">
                    ...
                    <a href="{{ route('admin.consulta.escalafon.form') }}" class="btn btn-limpiar px-4">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location.href = "{{ route('admin.consulta.escalafon.form') }}";
        }
    });
