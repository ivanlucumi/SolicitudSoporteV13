...
@section('title', 'Definir Solicitud')
@section('cabecera', 'Definir Solicitud')
@section('content') 
<link rel="stylesheet" href="/js/exportTabla/css/tableexport.css">
  ...
  <div class="container-fluid">
      <div class="row ">
            ...
            <form action="{{ route('admin.definir.solicitud.trabajo.remoto',$solicitud->id,'enctype'=>&quot;multipart/form-data&quot;) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
...
@enderror
          ...
          <div class="row">
               <div class="col-xs-12 col-sm-4 ">
                <label for="concepto_arl">Definir Estado:</label>
                <select id="select" class="form-control select2 @error('estado') is-invalid @enderror" autocomplete="off" name="estado">
    <option value="">Seleccione Viabilidad</option>
...
@enderror 
            ...
            <div class="col-xs-12 form-group ">
                ...
                <textarea class="form-control  @error('observaciones') is-invalid @enderror" id="demandante" autocomplete="off" placeholder="Observaciones" name="observaciones">{{ old('observaciones', $solicitud->observaciones ?? '') }}</textarea>
@error('observaciones')
    <div class="invalid-feedback">{{ $message }}</div>
@enderror
            </div>
