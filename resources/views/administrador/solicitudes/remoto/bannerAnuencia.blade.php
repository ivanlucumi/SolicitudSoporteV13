<div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1" id="modal-anuencia-{{$radicado->id}}" >
	<form enctype="multipart/form-data" action="{{ route('admin.subir.anuencia.teletrabajo.remoto',$radicado->id) }}" method="POST">
    @csrf
    @method('PUT')
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">SUBIR ANUENCIA</h4>
			</div>
			<div class="modal-body">
                ...
                <label for="archivo">Formato de anuencia para teletrabajo:</label>  <br>                          
