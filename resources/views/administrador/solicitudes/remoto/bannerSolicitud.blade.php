<div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1" id="modal-solicitud-{{$radicado->id}}" >
	<form enctype="multipart/form-data" action="{{ route('admin.subir.solicitud.teletrabajo.remoto',$radicado->id) }}" method="POST">
    @csrf
    @method('PUT')
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">SUBIR SOLICITUD</h4>
			</div>
			<div class="modal-body">
                ...
                <input accept=".pdf" class="form-control-file form-group @error('solicitud') is-invalid @enderror" id="anuencia" type="file" name="solicitud">
@error('solicitud')
