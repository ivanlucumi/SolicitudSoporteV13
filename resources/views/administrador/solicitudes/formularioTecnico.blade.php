		...
		<div class="col-xs-12 col-md-7 table-bordered titulo" >
			<strong>FORMATO DE ATENCIÓN A REQUERIMIENTOS INFORMÁTICOS</strong>
		   	...
		   	<div class="col-xs-12 col-md-3 table-bordered alto">
		       		<div>
		       			<strong>PRIORIDAD:  {{$solicitud[0]->prioridad}}</strong>
		       		</div>
		       		<div>
		       			<STRONG>DIAS:  </STRONG>{{$solicitud[0]->dias}}
		       		</div>
		</div>
	</div>	
</div>
	...
	<div class="col-xs-12">
		<div class="col-xs-12 col-md-3 table-bordered">
		  ...
		  <div class="col-xs-12 col-md-5 table-bordered">
			{{$solicitud[0]->nombre }} {{ $solicitud[0]->apellido}}
		   </div>
		   <div class="col-xs-12 col-md-2 table-bordered">
...
<div class="row">
	<div class="col-xs-12">
		<div class="col-xs-12 col-md-12 table-bordered">
			<textarea class="form-control @error('solucion') is-invalid @enderror" name="solucion" id="solucion">{{ old('solucion') }}</textarea>
@error('solucion')
    <div class="invalid-feedback">{{ $message }}</div>
@enderror 		
		</div>
...
<div class="row">
	<div class="col-xs-12">
		<div class="col-xs-12 col-md-2 table-bordered">
				...
				<div class="col-xs-12 col-md-4 table-bordered">
					<input class="form-control @error('cargo_tecnico') is-invalid @enderror" display="true" type="text" name="cargo_tecnico" id="cargo_tecnico" value="{{ old('cargo_tecnico') }}">
@error('cargo_tecnico')
    <div class="invalid-feedback">{{ $message }}</div>
@enderror
				</div>	
	...
	<div class="col-xs-12">
			...
			<div class="col-xs-12 col-md-12">
				<div class="form-group">
					<br>
					 @if($placas->all() != null) 
					 <select data-placeholder="Seleccione Placa" class="form-control select2 cColor @error('idPlaca[]') is-invalid @enderror" multiple="multiple" name="idPlaca[]" id="idPlaca[]">
