...
<div class="container-fluid">
  <div class="" style="text-align: right">
    <nav class="navbar navbar-light bg-light">
      <form action="{{ route('administrador.audiencias.resultado') }}" method="POST">
    @csrf
		  ...
		  <tr>
            ...
            <tbody data-id="{!!$solicitud->id!!}" class="buscar " >
                ...
                @endif>
                    ...
                    <th scope="row"><a href="{{ route('administrador.audiencias.editar', $solicitud->id) }}" class="btn btn-primary fa fa-pencil"> </a>	</th>
