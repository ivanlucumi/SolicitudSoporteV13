...
@section('cabecera', 'CARGAR EXCEL DE TELETRABAJO 2024')
...
<div class="row">
  ...
  <div class="col-xs-12 col-md-8"> 
    <form accept-charset="UTF-8" enctype="multipart/form-data" action="{{ route('administrador.save.excel.teletrabajo.2024') }}" method="POST">
    @csrf
