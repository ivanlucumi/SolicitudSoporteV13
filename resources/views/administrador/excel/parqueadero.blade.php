...
@section('title', 'Asignar Parqueadero por excel ')
@section('cabecera', 'Carga de Excel de Parqueadero')
...
<div class="row">
  ...
  <div class="col-xs-12 col-md-8">
    <form method="POST" action="/administrador/store/asignacion/parqueadero" accept-charset="UTF-8" enctype="multipart/form-data">  
