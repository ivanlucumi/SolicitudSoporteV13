...
@section('title', 'Crear Item Directorio')
@section('cabecera', 'Crear Item Directorio')
...
<form action="{{ route('directorio.store') }}" method="POST" id="directorioForm" novalidate>
  @csrf

  <div class="despacho-card">
    <div class="despacho-header">
      <h3>Crear Item Directorio</h3>
      ...
      <div class="col-xs-12 col-sm-6">
        <div class="form-group-min">
          ...
          <input type="text" name="dCiudad" id="dCiudad" maxlength="100"
                 ...
                 placeholder="Nombre de la Ciudad o Municipio" required>
      ...
      <div class="col-xs-12 col-sm-6">
        <div class="form-group-min">
          ...
          <input type="text" name="dCreador" id="dCreador" maxlength="50"
                 value="{{ old('dCreador',  auth()->user()->name) }}"
    ...
    <div class="row">
      <div class="col-xs-12 col-sm-6" style="margin-bottom: 0.8rem;">
        <button type="submit" class="btn-modern btn-guardar btn-block">
          <i class="fa fa-save"></i> Guardar Item Directorio
        </button>
      </div>
      <div class="col-xs-12 col-sm-6">
