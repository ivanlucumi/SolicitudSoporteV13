...
@section('cabecera', 'Crear Imagen/Video Banner')

@section('content') 
@include('../alerts.request')

<form action="{{ route('baner.bienestar.store') }}" method="POST" enctype="multipart/form-data" id="formBanner">
    @csrf
    ...
    <div class="row">
        ...
        <div class="col-xs-6">
            <div class="form-group">
                ...
                <input type="hidden" name="bModificador" value="{{  auth()->user()->name }}">
            </div>
        </div>
    </div>
