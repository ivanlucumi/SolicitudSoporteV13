        	...
        	<tr> 
             ...
             @foreach($notificaciones as $notificacion)
                ...
                <tr >
                 ...
                 <td>{{$notificacion->telefono_despacho}}</td>
                 <td>
                     <a href="{{ route('notificaciones.historico.solicitudes.despacho', $notificacion->id_seguimiento) }}" class="btn btn-warning btn-xs btn-block fa fa-eye fa-2x" title="editar usuario"> </a>
                 </td>
                </tr>
                </tbody>
            @endforeach
