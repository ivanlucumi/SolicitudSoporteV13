...
@section('cabecera')
SOLICITUD DE NOTIFICACION DE {{$notificacion[0]->despacho}}
@endsection
		   ...
		   <table border="0" class="table"  id="tablaDatos">
            <thead class="thead-dark">
              <tr></tr></thead>
                ...
                <div class="row"@if($notificacion->oficio === null)
...
@enderror
                    ...
                    <div class="col-xs-12 col-sm-2">
                    <label for="identidicacion">Oficio:</label>
                    <input class="form-control select2 @error('oficio') is-invalid @enderror" placeholder="Falta Oficio" autocomplete="off" id="tipo_parte" type="text" name="oficio" value="{{ old('oficio', $notificacion->oficio) }}">
@error('oficio')
    <div class="invalid-feedback">{{ $message }}</div>
@enderror
                  </div>
