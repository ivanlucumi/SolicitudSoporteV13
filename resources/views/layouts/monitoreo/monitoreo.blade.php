...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <!-- /.search form -->
    @if(  auth()->user()->email == 'monitoreo@disajcali.gov.co')
        <!-- Sidebar Menu -->
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header" style="color: #fff;"><strong>PANEL DE OPCIONES</strong> </li>
        <!-- Optionally, you can add icons to the links -->
       <li><a href="{!! route('monitoreo.index.ascensor')!!}"><i class="fa fa-at "></i> <span>Generar Reporte</span></a></li>
        
        <li><a href="{!! route('monitoreo.reporte.ascensor')!!}"><i class="fa fa-users"></i> <span>Reportes Realizados</span></a></li>
        </ul>
      <!-- /.sidebar-menu -->
     @else
