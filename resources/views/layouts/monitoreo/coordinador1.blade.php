  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        @if( auth()->user()->rol == 10)
        <li class="header" style="color: #fff;"><strong>ADMIN PARQUEADERO</strong> </li>
        ...
        <li><a href="{!!route('coordinador.control.consulta')!!}"><i class="fa fa-pencil-square"></i> <span>Registro Ingresos</span></a></li>
        </ul>
      <!-- /.sidebar-menu -->
    </section>
    <!-- /.sidebar -->
