  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <!--MENU PARA OFICINA DE REPARTO -->
        <li><a href="{!!route('reparto.noticias')!!}"><i class="fa fa-address-book"></i> <span>Index</span></a></li>
        <li class="treeview">
          <a href="#"><i class="fa fa-plus-circle" aria-hidden="true"></i> <span>Remision Reparto OFJ</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left  pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{!!route('reparto.ficha.remisiones')!!}"><i class="fa fa-rss-square"></i> <span>Fichas Remisi&oacute;n</span></a></li>
           <li><a href="{!! route('reparto.ficha.remisiones.historico')!!}"><i class=" fa fa-line-chart" ></i> <span>Hist&oacute;rico</span></a></li>
          </ul>
        </li>
        @if( auth()->user()->rol == 15)
        
        <li><a href="{!!route('reparto.index')!!}"><i class="fa fa-address-book"></i> <span>Ventanilla Virtual</span></a></li>
         <li><a href="{!!route('reparto.index.asignado')!!}"><i class="fa fa-address-book"></i> <span>Reparto Asignado</span></a></li>
        <li><a href="{!!route('reparto.con.reparto')!!}"><i class="fa fa-address-book"></i> <span>Hist&oacute;rico Reparto</span></a></li>
        <li><a href="{!!route('reparto.con.estadistica')!!}"><i class="fa fa-address-book"></i> <span>Estad&iacute;stica</span></a></li>
        @else
        
        <li><a href="{!!route('reparto.index')!!}"><i class="fa fa-address-book"></i> <span>Reparto</span></a></li>
        <li><a href="{!!route('reparto.con.reparto')!!}"><i class="fa fa-address-book"></i> <span>Con Reparto</span></a></li>
        @endif
      </ul>
      <!-- /.sidebar-menu -->
    </section>
