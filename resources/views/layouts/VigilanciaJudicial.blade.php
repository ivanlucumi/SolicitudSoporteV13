  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="{!!route('reparto.vigilancia.judicial.index')!!}"><i class="fa fa-rss-square"></i> <span>Solicitudes</span></a></li>
        <li><a href="{!! route('reparto.vigilancia.judicial.historico')!!}"><i class=" fa fa-line-chart" ></i> <span>Hist&oacute;rico</span></a></li>
          </ul>
        <!--li class="treeview">
