  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header" style="color: #fff;"><strong>Archivo General CSJ-SPOA</strong> </li>
        <!--MENU PARA OFICINA DE REPARTO -->
        
        <li><a href="{!!route('expediente.registrar.expediente')!!}"><i class="fa fa-book"></i> <span>Solicitud Pr&eacute;stamo</span></a></li>
        <li><a href="{!!route('expediente.pestamo')!!}"><i class="fa fa-address-book"></i> <span>Pr&eacute;stamos</span></a></li>
        <li><a href="{!!route('expediente.historial.prestamo')!!}"><i class="fa fa-bar-chart"></i> <span>Historial Pr&eacute;stamos</span></a></li>
      </ul>
      <!-- /.sidebar-menu -->
    </section>
    <!-- /.sidebar -->
