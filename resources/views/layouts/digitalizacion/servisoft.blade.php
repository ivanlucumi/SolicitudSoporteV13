  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="{!!route('novedades.servisoft')!!}"><i class="fa fa-address-book"></i> <span>Index Protocolo Uno</span></a></li>
        @if( auth()->user()->email == "ysuarez@servisoft.com.co" ||  auth()->user()->email == "conecttate.net@gmail.com")
        <li><a href="{!!route('servisoft.registroInventario')!!}"><i class="fa fa-book"></i> <span>Inventario Digitalizaci&oacute;n</span></a></li>
        @endif
        
        <li class="header" style="color: #fff;"><strong>PROTOCOLO 2</strong> </li>
         <li><a href="{!!route('novedades.servisoft.prot.dos')!!}"><i class="fa fa-address-book"></i> <span>Index Protocolo Dos</span></a></li>
          <li><a href="{!!route('servisoft.registro.incidentes')!!}"><i class="fa fa-free-code-camp" aria-hidden="true"></i> <span>Incidentes Digitalizaci&oacute;n</span></a></li>
          <li><a href="{!!route('supervisor.bestdco.inicio')!!}"><i class="fa fa-server" aria-hidden="true"></i> <span>Traslado a Bestdoc</span></a></li>
