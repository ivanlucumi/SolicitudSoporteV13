  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree" >
        ...
        <li><a href="{{route('operario.index')}}" ><i class="fa fa-info-circle"></i> <span >INICIO</span></a></li>
        
        <li><a href="{{route('operario.index.cerrado')}}" ><i class="fa fa-info-circle"></i> <span >CASOS CERRADOS</span></a></li>
      </ul>
      <!-- /.sidebar-menu -->
    </section>
    <!-- /.sidebar -->
