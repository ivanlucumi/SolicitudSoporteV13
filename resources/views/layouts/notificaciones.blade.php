  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="{!!route('notificaciones.index')!!}"><i class="fa fa-address-book"></i> <span>Notificaciones</span></a></li>
        <li><a href="{!!route('notificaciones.en_proceso')!!}"><i class="fa fa-address-book"></i> <span>Con Oficio</span></a></li>
        <li><a href="{!!route('notificaciones.historico.solicitudes')!!}"><i class="fa fa-address-book"></i> <span>Hist&oacute;rico</span></a></li>
        ...
        <!--li ><a href="{!!route('usuario.solicitud.capacitacion')!!}"><i class="fa fa-address-book" readonly></i> <span>Solicitud Capacitaci&oacute;n</span></a></li-->
        <!--li ><a href="{!!route('usuario.ingreso')!!}"><i class="fa fa-pencil-square" readonly></i> <span>Solicitud ingreso</span></a></li-->
        ...
        @if( auth()->user()->certifico_personal != 1)
        <!--li><a href="{!!route('usuario.empleados.despacho')!!}" ><i class="fa fa-pencil-square"></i> <span>Confirmar Empleados</span></a></li-->
        @endif
