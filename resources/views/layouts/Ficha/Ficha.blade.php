  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="{!!route('adminfichas.index')!!}"><i class="fa fa-address-book fa-2x"></i> <span style="margin-left: 5%"><strong>Solicitudes</strong> </span></a></li>
        @if( auth()->user()->email == "avargasmo@cendoj.ramajudicial.gov.co" || auth()->user()->email == "yordoneg@cendoj.ramajudicial.gov.co")
             <li><a href="{!!route('adminfichas.historico.cerrado')!!}"><i class="fa fa-bar-chart fa-2x"></i> <span style="margin-left: 5%"><strong> Hist&oacute;rico</strong></span></a></li>
             <li><a href="{!!route('adminfichas.despacho.disponible')!!}"><i class="fa fa-telegram fa-2x"></i> <span style="margin-left: 5%"><strong>Notificaci&oacute;n Turno</strong></span></a></li>
             
        @endif
        <li><a href="{!!route('adminfichas.misRegistros')!!}"><i class="fa fa-street-view fa-2x"></i> <span style="margin-left: 5%"><strong> Mis Tr&aacute;mites</strong></span></a></li>
