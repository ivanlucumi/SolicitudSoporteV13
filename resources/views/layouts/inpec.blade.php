  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="{!! route('inpec.index')!!}"><i class="fa fa-home"></i> <span>Home </span></a></li>
        <li><a href="{!! route('inpec.citaciones')!!}"><i class="fa fa-address-book"></i> <span>Citaciones </span></a></li>
      </ul>
      <!-- /.sidebar-menu -->
    </section>
    <!-- /.sidebar -->
