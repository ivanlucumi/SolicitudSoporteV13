  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="{!! url('/tecnicos')!!}"><i class="fa fa-gavel"></i> <span>Solicitudes....</span></a></li>
        <li><a href="{!! url('/tecnico/missolicitudes')!!}"><i class="fa fa-address-book"></i> <span>Mis solicitudes</span></a></li>
