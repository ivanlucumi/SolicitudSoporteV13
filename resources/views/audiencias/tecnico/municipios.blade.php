...
<div class="" style="text-align: left">	
	<a href="{!! url('tecnicos/mcipios')!!}" class="btn btn-warning btn-sm" >Audiencias Municipios</a>
</div>

<div class="container-fluid">
  <div class="" style="text-align: right">
    <nav class="navbar navbar-light bg-light">
      <form action="{{ route('tecnico.solicitud.mcipios') }}" method="POST">
    @csrf
            ...
            <tbody data-id="{!!$solicitud->id!!}" class="buscar " >
                ...
                @endif>
                    ...
                    <th scope="row">{{$solicitud->telefono}}</th>
                     ...
                     <form action="{{ route('tecnico.almacenar.solicitud.municipio',$solicitud->id) }}" method="POST">
    @csrf
    @method('PUT')          
                    ...
                    <th>
                           ...
                           <center>
                            @if($solicitud->quien_asigno ==  auth()->user()->id)
                             ...
                             <!-- soltar-->
                             <form action="{{ route('tecnico.soltar.estado.solicitud.municipio',$solicitud->id) }}" method="POST">
    @csrf
    @method('PUT')          
