...
<div class="" style="text-align: left">	
	<a href="{!! url('tecnicos')!!}" class="btn btn-warning btn-sm" >Audiencias Hoy</a>
</div>

<div class="container-fluid">
  <div class="" style="text-align: right">
    <nav class="navbar navbar-light bg-light">
      <form action="{{ route('tecnico.solicitud.porfecha') }}" method="POST">
    @csrf
...
<div class="table-responsive shadow">
  ...
  height: 800px">
	...
	<div >
	    <thead class="shadow" style="background-color: #004182; color: #fff; width:100px; height:115px; overflow: scroll">
		    <tr class="shadow">
		        <th>EMAIL</th>
