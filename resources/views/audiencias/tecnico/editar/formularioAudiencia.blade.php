...
<div class="row ">
    ...
    <div class="col-xs-12 col-sm-6 col-md-3 form-group ">
        ...
        <div class="row">
            ...
            <label><input type="radio" id="cbox1" value="1" name="detenido" disabled onClick="condetenido()" @if($solicitudAudiencia->detenido == '1')
            ...
            <div class="col-xs-12 col-lg-6">
                ...
                <label><input type="radio" id="cbox2" value="0" name="detenido" disabled onClick="sindetenido()" @if($solicitudAudiencia->detenido == '0')
