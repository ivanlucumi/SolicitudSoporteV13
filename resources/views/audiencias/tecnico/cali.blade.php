...
@section('title', 'Solicitud Audiencia Cali')
@section('cabecera', ' Solicitud de Audiencia Cali')

@section('content') 


<div class="" style="text-align: left">	
	<a href="{!! url('tecnico/solicitud/audiencia/virtual')!!}" class="btn btn-warning btn-sm" >Audiencias Cali</a>
</div>
  ...
  height: 800px">
	    ...
	    <thead class="shadow" style="background-color: #004182; color: #fff;">
		    <tr class="shadow">
				...
				<th scope="col">DECLARANTE O INDICIADO</th>	
            ...
            <tbody data-id="{!!$solicitud->id!!}" class="buscar " >
                ...
                @endif>
                    ...
                    <th scope="row" style="width:1px !important">{{str_replace(' ', '', $solicitud->telefono)}}</th>

                    <form action="{{ route('tecnico.almacenar.solicitud',$solicitud->id) }}" method="POST">
    @csrf
    @method('PUT')          
                    ...
                    <th>
                       <center>
                        @if($solicitud->quien_asigno ==  auth()->user()->id)
                         ...
                         <!-- soltar-->
                         <form action="{{ route('tecnico.soltar.estado.solicitud',$solicitud->id) }}" method="POST">
    @csrf
    @method('PUT')          
