...
@section('title', 'Historico Ficha Remision')
@section('cabecera', 'Historico Ficha Remision')
@section('content') 
             ...
             @foreach($fichas as $ficha)
                ...
                <tr>
                 ...
                 <td>
                    ...
                    <a onClick="window.open('/fichaRemision/{{$ficha->consulta}}','popup', 'width=800px,height=600px')">DOC CONSULTA</a> 
                    @endif
                 </td>
