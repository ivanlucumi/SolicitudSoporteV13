...
@section('content') 
 <div class="col-xs-12 col-sm-2">
         <div class="" style="text-align: left">	
        	<a href="{!! route('usuario.historico.ficha.preliminar')!!}" class="btn btn-primary " >VER TODO</a>
        </div>
    </div>
 ...
 <div class="col-xs-12 col-sm-10">
        <div class="" style="text-align: left">
            ...
            <nav class="navbar navbar-light bg-light">
              <form action="{{ route('usuario.historico.ficha.preliminar') }}" method="POST">
    @csrf
            ...
            @if($fichas != null)
             @foreach($fichas as $ficha)
                ...
                @endif>
                 ...
                 <td>{{$ficha->cedula_quien_solicita}}<br> {{$ficha->quien_solicita}} </td>
