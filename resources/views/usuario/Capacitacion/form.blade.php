	...
	<div class="row justify-content-md-center">
            ...
            <div class="col-xs-12 col-sm-8">
              <div class="card mb-3" >
                  <div class="row no-gutters">
                    <div class="col-md-12">
                     <center> <img src="/img/SGDE.png" class="card-img" width="500em" height="230em"></center>
                    </div>
                    <div class="col-md-12">
                      <div class="card-body">
                         <p class="card-text"><h3><strong><center>FORMULARIO PARA REGISTRO DE ASISTENCIA CAPACITACI&Oacute;N PISO 18 TORRE B PALACIO JUSTICIA "PEDRO ELÍAS SERRANO ABADÍA" DE CALI. <br> <span style="color:red"></span> </center></strong></h3> </p>
                        <br>
      ...
      <div class="row" >
        ...
        <div class="col-xs-12 col-sm-8">
                    ...
                    <h3>
                     <strong> AYUDAS PARA EL MANEJO DEL SGDE 
...
<center>
    <h2>
        CAPACIDAD POR JORNADA 30 PERSONAS PARA LA ESPECIALIDAD CIVIL
    </h2>
</center>
    
  @if( auth()->user()->rol == 3)
  <form action="{{ route('usuario.store.capacitacion') }}" method="POST">
    @csrf  
              ...
              @for($i=0;$i<count($fecha);$i++)
                    @if($fecha[$i] >=  \Carbon\Carbon::now()->toDateString())
                      <div class="col-xs-6 col-sm-2 mb-3 mt-3">
                          ...
                          <label><input type="radio" required id="cbox3" value="{{ $fecha[$i] }}" name="fecha"  > <font size=3 > {{ $fecha[$i] }}</font></label>
