              ...
              <form action="{{ route('reporte.incidente.update.save') }}" method="POST">
        				...
        				<div class="form-group">
                		     <label for="estado">Estado:</label>
                                <select name="estado" id="estado" class="form-control" required>	
                                    ...
                                    <option value="ARREGLO PARCIAL" >ARREGLO PARCIAL</option>
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-6">
                    <div class="form-group">
                        ...
                        <select name="asignado_a" id="asignado_a" placeholder="Seleccione Operario Mantenimiento" class="form-control">
                            <option value="" >SELECCIONE OPERARIO</option>
                            @foreach($operario as $key => $value)
                                <option value="{{ $key }}" @selected(old('asignado_a', null) == $key)>{{ $value }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        ...
                        <label>OBSERVACIONES:</label>
                            <textarea name="observaciones" id="observaciones" placeholder="Descripcion de la soluciÃ³n" class="form-control" id="Idobservaciones">{{ old('observaciones') }}</textarea>
                        </div>
