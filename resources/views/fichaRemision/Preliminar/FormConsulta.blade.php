...
<head>
  ...
  <title>Consulta Solicitud de Audiencias Preliminares</title>
              ...
              <div class="card-body">
                ...
                <div class="col-md-12">
                        ...
                        <div class="card-header" style="background-color: #004182;color:white"><h4><center>CENTRO DE SERVICIOS JUDICIALES PARA LOS JUZGADOS PENALES MUNICIPALES Y DEL CIRCUITO DE CALI<br> VALLE DEL CAUCA</center></h4></div>
                           ...
                           <hr>
                            <form id="MiFormulario" class="was-validated" action="{{ route('publico.ficha.preliminar.consulta.resultado') }}" method="POST">
    @csrf 
                <div class="row">
...
@enderror
                        ...
                        <div class="row">
                           <div class="col-xs-12 col-sm-6">
                               <h5><strong>N&Uacute;MERO SEGUIMIENTO:</strong></h5>
                           </div> 
                           <div class="col-xs-12 col-sm-6">
                              	<input class="form-control @error('num_seguimiento') is-invalid @enderror" placeholder="N&uacute;mero de Seguimiento" autocomplete="off" type="text" name="num_seguimiento" id="num_seguimiento" value="{{ old('num_seguimiento') }}">
@error('num_seguimiento')
    <div class="invalid-feedback">{{ $message }}</div>
@enderror<br>
                           </div> 
                        </div>
