...
<link rel="stylesheet" href="/js/exportTabla/css/tableexport.css">
    ...
    <div class="col-xs-12 col-sm-2">
         <div class="" style="text-align: left">
        	<a href="{!! route('adminfichas.misRegistros')!!}" class="btn btn-warning " >VER TODO</a>
        </div>
    </div>
...
$("table").tableExport({
	...
	fileName: "Historico Mis Registros",    //Nombre del archivo 
});
