...
<head>
  ...
  <title>ACTA DE INSTALACION PORTATIL</title>
      ...
      <div class="card-body">
        ...
        <div class="col-md-12" style="display:block">
             ...
             @include('../alerts.success')
                ...
                @if ($soporte->id)
			    <form action="{{ route('tecnico.firma.portatiles.store',$soporte->id) }}" method="POST">
    @csrf
    @method('PUT')
                @else

                <form action="{{ route('tecnico.firma.portatiles.store') }}" method="POST">
    @csrf
                @endif
                <div class="card-header"><h3><center>ACTA DE INSTALACION PORT&Aacute;TIL<br>
                                                    ORDEN DE COMPRA 116415 DE 2023
                                            </center>
                                        </h3>
                </div>
...
<script>
    ...
    verifSerie.addEventListener('input', function() 
    {
        ...
        $.get("/tecnico/soporte/consulta/serie/portatil/" + this.value + "", function(response) {
