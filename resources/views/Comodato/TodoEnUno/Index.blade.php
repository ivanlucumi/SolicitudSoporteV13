...
<head>
  ...
  <title>ACTA DE INSTALACION TODO EN UNO</title>
...
<link href="{{asset('/adminlte/bower_components/select2/dist/css/select2.min.css')}}">
      ...
      <div class="card-body">
        ...
        <div class="col-md-12" style="display:block">
             ...
             @include('../alerts.success')
                ...
                @if ($soporte->id)
			    <form action="{{ route('tecnico.firma.todo_en_uno.store',$soporte->id) }}" method="POST">
    @csrf
    @method('PUT')
                @else

                <form action="{{ route('tecnico.firma.todo_en_uno.store') }}" method="POST">
    @csrf
                @endif
                <div class="card-header"><h3><center>ACTA DE INSTALACION TODO EN UNO<br>
                                                    ORDEN DE COMPRA No. 139044 DE 2024 
                                            </center>
                                        </h3>
                </div>
...
@enderror
                                ...
                                <div class=" col-xs-12 col-md-2">
                                  <label for="especialidad">* USUARIO DOMINIO:</label>
                                  <input id="usuario_dominio" class="form-control @error('usuario_dominio') is-invalid @enderror" placeholder="Ingrese Usuario Doiminio" autocomplete="off" type="text" name="usuario_dominio" value="{{ old('usuario_dominio', $soporte->usuario_dominio ?? $soporte-> usuario_dominio) }}">
@error('usuario_dominio')
    <div class="invalid-feedback">{{ $message }}</div>
@enderror
                                </div>
                                <div class=" col-xs-12 col-md-4">
                                  <label for="especialidad">* CORREO PERSONAL INSTITUCIONAL:</label>
                                  <input id="correo_personal_inst" class="form-control @error('correo_personal_inst') is-invalid @enderror" placeholder="Ingrese Correo Personal Institucional" autocomplete="off" type="text" name="correo_personal_inst" value="{{ old('correo_personal_inst', $soporte->correo_personal_inst ?? $soporte-> correo_personal_inst) }}">
@error('correo_personal_inst')
    <div class="invalid-feedback">{{ $message }}</div>
@enderror
                                </div>
...
@enderror
                                ...
                                <div class=" col-xs-12 col-md-4">
                                  <label for="placa">* Placa Teclado:</label>
                                  <input id="placa_teclado" class="form-control @error('placa_teclado') is-invalid @enderror" placeholder="Ingrese Placa del Equipo" min="1" autocomplete="off" type="text" name="placa_teclado" value="{{ old('placa_teclado', $soporte->placa_teclado ?? $soporte->placa_teclado) }}">
@error('placa_teclado')
    <div class="invalid-feedback">{{ $message }}</div>
@enderror
                                </div>
                                 ...
                                 <div class=" col-xs-12 col-md-4">
                                   <label for="serial">* Serial Teclado:</label>
                                  <input id="serial_teclado" class="form-control @error('serial_teclado') is-invalid @enderror" placeholder="Ingrese Serial" autocomplete="off" type="text" name="serial_teclado" value="{{ old('serial_teclado', $soporte->serial_teclado ?? $soporte->serial_teclado) }}">
@error('serial_teclado')
    <div class="invalid-feedback">{{ $message }}</div>
@enderror

                                </div>
                                <div class=" col-xs-12 col-md-4">
                                  <label for="placa">* Placa Mouse:</label>
                                  <input id="placa_mouse" class="form-control @error('placa_mouse') is-invalid @enderror" placeholder="Ingrese Placa del Equipo" min="1" autocomplete="off" type="text" name="placa_mouse" value="{{ old('placa_mouse', $soporte->placa_mouse ?? $soporte->placa_mouse) }}">
@error('placa_mouse')
    <div class="invalid-feedback">{{ $message }}</div>
@enderror
                                </div>
                                 ...
                                 <div class=" col-xs-12 col-md-4">
                                   <label for="serial">* Serial Mouse:</label>
                                  <input id="serial_mouse" class="form-control @error('serial_mouse') is-invalid @enderror" placeholder="Ingrese Serial" autocomplete="off" type="text" name="serial_mouse" value="{{ old('serial_mouse', $soporte->serial_mouse ?? $soporte->serial_mouse) }}">
@error('serial_mouse')
    <div class="invalid-feedback">{{ $message }}</div>
@enderror
                                 ...
                                 <div class=" col-xs-12 col-md-4" id="form_ip">
                                   <label for="ip">* Ip Portatil:</label>
...
<script>
    ...
    verifCedula.addEventListener('input', function() 
    {
        ...
        $.get("/tecnico/soporte/consulta/cedula/asignacion/" + this.value + "", function(response, juzgado) {

            
            console.log(typeof response[0])
            document.getElementById('nombre_contacto').value = "";
                document.getElementById('usuario_dominio').value = "";
                document.getElementById('correo_personal_inst').value = "";
            ...
            if (Object.keys(response).length > 0) {
                ...
                if( typeof response[0] !== 'undefined'){
                    ...
                    document.getElementById('nombre_contacto').value = response.nombre;
                    document.getElementById('usuario_dominio').value = response.usuario;
                    document.getElementById('correo_personal_inst').value = response.correo;
                    document.getElementById('ip').value = response.ip;
                    
                    document.getElementById('telefono').value = response.telefono+" EXT "+response.extension;
                    document.getElementById('direccion').value = response.direccion;
                    
                    document.getElementById('seccional').value = "CALI";
                    document.getElementById('email').value = response.correoD;
                    $("#despacho").val(response.cod_despacho);
                    $("#ciudad").val(response.nombreCiudad);
    ...
    verifSerie.addEventListener('input', function() 
    {
        ...
        document.getElementById('placa_equipo').value = "";
        document.getElementById('serial_equipo').value = "";
        document.getElementById('modelo').value = "";
        document.getElementById('serial_teclado').value = "";
        document.getElementById('placa_teclado').value = "";
        document.getElementById('serial_mouse').value = "";
        document.getElementById('placa_mouse').value = "";

        $.get("/tecnico/soporte/consulta/serie/todo_en_uno/" + this.value + "", function(response) {
                console.log(response.placa_equipo)
                console.log(response.serial_equipo)
                
                
            if (Object.keys(response).length > 0) {
                document.getElementById('placa_equipo').value = response.placa_equipo;
                ...
                document.getElementById('serial_teclado').value = response.serial_teclado;
                document.getElementById('placa_teclado').value = response.placa_teclado;
                document.getElementById('serial_mouse').value = response.serial_mouse;
                document.getElementById('placa_mouse').value = response.placa_mouse;
...
<script>
 const boton1 = document.getElementById('oculto-guardar');
const boton2 = document.getElementById('bt_envio');

// Agregar un evento de clic al primer botón
boton1.addEventListener('click', function() {
    // Desencadenar el evento clic en el segundo botón
   // boton2.click();
});
