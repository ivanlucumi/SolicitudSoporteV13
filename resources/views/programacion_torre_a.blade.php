...
@section('title', 'Prograci&oacute;n Audiencias Torre A')
...
@enderror
					...
					<div class="col-xs-12 col-sm-4">
					<button class="btn btn-warning btn-block" style="background-color: #004182" type="submit">Buscar Audiencia A</button>
					</form>
					</div>
					<div class="col-xs-12 col-sm-4">
					<form action="{{ route('programacion_torre_b') }}" method="POST">
    @csrf	
					<button class="btn btn-warning btn-block" style="background-color: #807E7E" type="submit">Ir a Torre B</button>
					</form>
					</div>
				</div>
			</div>
